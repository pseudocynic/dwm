...
static const char col_gray1[]       = "#737373"; // background colour
static const char col_gray2[]       = "#444444"; // inactive window border colour 
static const char col_gray3[]       = "#000000"; // font colour
static const char col_gray4[]       = "#000000"; // current tag and current window font colour
static const char col_cyan[]        = "#d9d9d9"; // Top bar second colour (blue) and active window border colour
